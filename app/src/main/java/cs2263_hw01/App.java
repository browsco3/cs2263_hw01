 ...
 */
/**
 * This program is for cs2263 Homework 2.
 * @author Scott Brown
 * @date 2022-2-6
 */
package cs2263_hw01;
...
public class App {
    ...
    public static double eval(String operator, double first, double second) {
         ...
         * @return Returns the result of the expression as a double.
         */
        switch (operator) {
            case "+":
                return first + second;
    ...
    public static double breakUpExpression(String expression) {
        /**
         * This method takes in a whole expression, breaks it up into pieces, solves the pieces, and returns the result.
         * @param expression  The string containing the expression to be evaluated.
         * @return Returns the expression result as a double.
         */
        String holder = null;
